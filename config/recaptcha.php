...
return [
    ...
    */
    'recaptcha_v3' => [
        ...
        'error_message' => 'Sorry, but reCAPTCHA has detected suspicious activity and identified you as a bot. If you believe this is an error, please contact us using the contact form available on this site.',
